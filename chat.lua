---
-- The Ashita chat lua library shamelessly copied for easy windower compatibility.
-- @author atom0s
local chat = { };
...
chat.color1 = function (n, str)
    return string.format('\30%c%s\30\01', n, str);
end
...
chat.color2 = function (n, str)
    return string.format('\31%c%s\30\01', n, str);
end
...
chat.header = function (str)
    return string.format('\30\81[\30\06%s\30\81]\30\01 ', str);
end
...
--[[
* Returns the string wrapped in a green color.
*
* @param {string} str - The string to wrap.
* @return {string} The wrapped string.
--]]
chat.location = function (str)
    return chat.color1(2, str);
end

--[[
* Returns the string wrapped in a magenta color.
*
* @param {string} str - The string to wrap.
* @return {string} The wrapped string.
--]]
chat.event = function (str)
    return chat.color1(5, str);
end

--[[
* Returns the string wrapped in a light gray color.
*
* @param {string} str - The string to wrap.
* @return {string} The wrapped string.
--]]
chat.invalid = function (str)
    return chat.color1(67, str);
end

--[[
* Returns the string wrapped in a blue color.
*
* @param {string} str - The string to wrap.
* @return {string} The wrapped string.
--]]
chat.highlight = function (str)
    return chat.color1(82, str);
end

--[[
* Returns the string wrapped in a brown color.
*
* @param {string} str - The string to wrap.
* @return {string} The wrapped string.
--]]
chat.callback = function (str)
    return chat.color1(85, str);
end
...
* @return {string} The wrapped string.
--]]
chat.transition = function (str)
    return chat.color1(89, str);
end
